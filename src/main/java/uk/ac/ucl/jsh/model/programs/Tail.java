...
public class Tail extends AbstractProgram {

    public static final String PROGRAM_COMMAND = "tail";
    ...
    private void writeToShell(BufferedReader reader, int tailLines) throws IOException {
        int index = 0;
